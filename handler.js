    ...
    try {
        ...
        try {
            ...
            if (user) {
                ...
                if (!isNumber(user.limit)) user.limit = 99999
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '❌ ¡Este comando só pode ser usado pelo número proprietário! ❌',
        owner: '❌ ¡Este comando só pode ser usado pelo número proprietário! ❌',
        ...
        admin: '*❌ ¡SILÊNCIO MEMBRO COMUM! VOCÊ NÃO TEM MORAL PRA USAR ESSE COMANDO ❌*',
