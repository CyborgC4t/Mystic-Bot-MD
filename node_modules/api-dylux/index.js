...
exports.facebook2 = (url) => {
    return new Promise(async (resolve, reject) => {
        ...
        axios.post(host + '/system/action.php', qs.stringify(form.data), { headers: is.headers })
            .then(({ data }) => {
                if (data == 'error') return resolve({ creator: '@FG98', status: false })
                resolve({ creator: '@FG98', status: true, thumb: data.thumbnail, data: data.links })
            })
    })
}
...
module.exports.TiktokDl = TiktokDl2
